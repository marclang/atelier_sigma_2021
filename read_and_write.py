...
def write_image(out_filename, array, data_set=None, gdal_dtype=None,
                ...
                nb_col=None, nb_ligne=None, nb_band=None, no_data = None):
    """
...
def report_from_dict_to_df(dict_report):
    """
    Convertit les rapport en dataframe

    Parameters
    ----------
    dict_report : dictionnaire
...
# def extract_sample (image_filename, sample_filename, field_name="label", is_point=False):
#     """
#     Extraction des échantillons (polygones ou points)

#     Parameters
#     ----------
#     image_filename : image de référence 
#     sample_filename : vecteur d'échantillons
#     field_name : nom du champ contenant les labels (défaut : label)
#     is_Point : False - échantillon de polygone (défaut)
#                True - échantillon de point

#     Returns
#     -------
#     X : dataframe
#             coordoonnées des échantillons
#     Y : dataframe
